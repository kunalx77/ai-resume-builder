  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          type="text"
          placeholder="Enter a skill (e.g., JavaScript, C++, Leadership)"
          className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring focus:ring-blue-500 outline-none"
          value={newSkill}
