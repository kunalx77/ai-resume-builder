            ...
            return (
              ...
              >
                ...
                <div onClick={e=> e.stopPropagation()} className="absolute top-1 right-1 hidden group-hover:flex">
                  <Trash onClick={()=>deleteResume(resume._id)} className="size-7 p-1.5 hover:bg-white/50 rounded" />
                  <Pencil onClick={()=>{setEditResumeId(resume._id); setTitle(resume.title)}} className="size-7 p-1.5 hover:bg-white/50 rounded" />
                </div>
              </button>
            )
          })}
        ...
        {showUploadResume && (
          ...
          >
            ...
            >
              ...
              <button
              disabled={isLoading}
              className="relative w-full py-2 rounded text-white overflow-hidden
              bg-green-600 disabled:cursor-not-allowed"
              >
              {isLoading && (
